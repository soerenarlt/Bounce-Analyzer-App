...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS="-lpython3.8 -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -lbz2 -llzma -lz -lm $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -lbz2 -llzma -lz -lm $SYSLIBS"
